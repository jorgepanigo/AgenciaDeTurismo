...
<head>
    ...
    <title>Nuevo Cliente - Silicon Travel </title>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Registro de nuevos clientes. </p>
                        </div>
                    </div>
                                    ...
                                    <form action="SvClienteA" method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                 ...
                                                 <input name="fecha-nac" type="text" class="form-control" placeholder="dd-mm-aaaa" id="mdate">
                                            </div>
                                            <div class="form-group col-md-4">
