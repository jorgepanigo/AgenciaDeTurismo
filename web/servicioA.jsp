...
<head>
    ...
    <title>Nuevo Servicio - Silicon Travel </title>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Ingreso de nuevos servicios. </p>
                        </div>
                    </div>
                                    ...
                                    <form action="SvServicioA" method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                 ...
                                                 <input name="fechaserv" name="fecha" type="date" class="form-control" id="mdate" placeholder="dd-mm-aaaa">
                                            </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="descripcion" type="text" rows="4" class="form-control"></textarea>
                                            </div>
