                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Alta de Medio de Pago</h4>
                            <p class="mb-0">Registro de nuevas formas de pago para ventas. </p>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Nuevo Medio de pago</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="SvMedioDePagoA" method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input name="comision" type="text" class="form-control">
                                            </div>
