    ...
    public void create(Cliente cliente) {
        ...
        try {
            ...
            for (Venta ventasVentaToAttach : cliente.getVentas()) {
                ventasVentaToAttach = em.getReference(ventasVentaToAttach.getClass(), ventasVentaToAttach.getNumVenta());
    ...
    public void edit(Cliente cliente) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Venta ventasNewVentaToAttach : ventasNew) {
                ventasNewVentaToAttach = em.getReference(ventasNewVentaToAttach.getClass(), ventasNewVentaToAttach.getNumVenta());
