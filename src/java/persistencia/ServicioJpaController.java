...
public class ServicioJpaController implements Serializable {
    ...
    public void create(Servicio servicio) {
        ...
        try {
            ...
            for (Paquete listaPaquetesPaqueteToAttach : servicio.getListaPaquetes()) {
                listaPaquetesPaqueteToAttach = em.getReference(listaPaquetesPaqueteToAttach.getClass(), listaPaquetesPaqueteToAttach.getCodigoProducto());
    ...
    public void edit(Servicio servicio) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Servicio persistentServicio = em.find(Servicio.class, servicio.getCodigoProducto());
            ...
            for (Paquete listaPaquetesNewPaqueteToAttach : listaPaquetesNew) {
                listaPaquetesNewPaqueteToAttach = em.getReference(listaPaquetesNewPaqueteToAttach.getClass(), listaPaquetesNewPaqueteToAttach.getCodigoProducto());
            ...
            if (msg == null || msg.length() == 0) {
                int id = servicio.getCodigoProducto();
