...
public class PaqueteJpaController implements Serializable {
    ...
    public void create(Paquete paquete) {
        ...
        try {
            ...
            for (Servicio listaServiciosServicioToAttach : paquete.getListaServicios()) {
                listaServiciosServicioToAttach = em.getReference(listaServiciosServicioToAttach.getClass(), listaServiciosServicioToAttach.getCodigoProducto());
    ...
    public void edit(Paquete paquete) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Paquete persistentPaquete = em.find(Paquete.class, paquete.getCodigoProducto());
            ...
            for (Servicio listaServiciosNewServicioToAttach : listaServiciosNew) {
                listaServiciosNewServicioToAttach = em.getReference(listaServiciosNewServicioToAttach.getClass(), listaServiciosNewServicioToAttach.getCodigoProducto());
            ...
            if (msg == null || msg.length() == 0) {
                int id = paquete.getCodigoProducto();
