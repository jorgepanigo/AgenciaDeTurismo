...
<head>
    ...
    <title>Eliminar Servicio - Silicon Travel </title>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Eliminacion de servicios cargados en el sistema. </p>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="SvServicioB" action="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>Nombre</label>
                                                <input value="<%= ser.getNombre() %>" name="nombre" type="text" class="form-control" readonly="">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label>Destino</label>
                                                <input value="<%= ser.getDestino() %>" name="destino" type="text" class="form-control" readonly="">
                                            </div>
                                            <div class="form-group col-md-3">
                                                 <label>Fecha de Servicio</label>
                                                 <input  name="fechaserv" type="textS" class="form-control" id="mdate" 
                                                         value="<%= controlL.dateAString(ser.getFechaServicio())%>" readonly=""/>
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label>Costo</label>
                                                <input value="<%= ser.getCosto().toString() %>" name="costo" type="text" class="form-control" readonly="">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Descripcion Breve</label>
                                                <textarea name="descripcion" type="text" rows="4" class="form-control" readonly=""><%= ser.getDescripcion() %></textarea>
                                            </div>
